...
public:
  ...
  TimeStepControlStrategyIntegralController()
    : name_("Integral Controller"), controller_("PID"),
      KI_(0.58), KP_(0.21), KD_(0.10),
  ...
  TimeStepControlStrategyIntegralController( std::string controller,
    ...
    Scalar facMax, Scalar facMin)
    : name_("Integral Controller"), controller_(controller),
  ...
  Teuchos::RCP<const Teuchos::ParameterList> getValidParameters() const
  {
    ...
    pl->set<std::string>("Name", getName(),"Integral Controller");
